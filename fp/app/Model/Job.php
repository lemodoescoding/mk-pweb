...
class Job extends Model
{
    ...
    try {
      ...
      $stmt = $this->db->prepare("
            INSERT INTO jobs (
                ...
                date_posted, raw_json
            ) VALUES (:eid, :title, :desc, :applink, :remote, :cid, :mis, :mas, :lid, :soid, :dpost, :rj)
        ");
      ...
      $stmt->bindValue(':cid', $data['company_id'], PDO::PARAM_STR);
      $stmt->bindValue(':lid', $data['location_id'], PDO::PARAM_STR);
      $stmt->bindValue(':mis', $data['min_salary'], PDO::PARAM_INT);
      $stmt->bindValue(':mas', $data['max_salary'], PDO::PARAM_INT);
      $stmt->bindValue(':soid', $data['source_id'], PDO::PARAM_STR);
  ...
  public function searchByCategory(string $category): void {}
}
