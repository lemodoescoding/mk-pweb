# A Brief to Pertemuan 12 - PWEB B - CRUD Upload Foto
...
4. Copy the code `ddl.sql` to the phpMyAdmin on the SQL tab (Run SQL Query) and run. It should create a database named `pertemuan12` with `siswa` table inside.
...
2. The page should load by the time you access the app main entry file `index.php`, and that should be it. You can try to do the CRUD action and stuff.
